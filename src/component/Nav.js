...
const Nav = () => {
    ...
    return(
        <div className="bg-black self-stretch px-3 py-5 flex flex-col items-center w-fit gap-5">
            ...
            <img src={onePiece} alt="one" className=" transition-all duration-400 ease-in-out object-cover w-14 h-14 bg-slate-800 rounded-[50%] cursor-pointer hover:rounded-2xl "/>
        </div>
    )
}
